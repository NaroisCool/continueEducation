                        ...
                        <div class="box span4">
                            ...
                            <div class="box-content time2">
                                <ul class="dashboard-list">
                                    ...
                                    <li>
                                        <span class="span4">现场上课：</span>
										
											<s:if test="#user.studyTypes != 2">
												<s:if test="#user.graduationTime == null"><a>未完成</a></s:if>
												<s:else><a>已完成</a></s:else>
											</s:if>
											<s:else>
												<a>无</a>
											</s:else>
                                        ...
                                        <li>
                                                <span class="span4" title="包含现场学时">网络已学：</span><a id="inf-timeuse">${code.studyUseTime} 分钟</a> <span>&nbsp;&nbsp;剩余时间：</span><a id="inf-timeleft">${code.studyLeftTime} 分钟</a> 
                                    </li>
                                    <li style="padding-left:30px;">
                                        <s:if test="#user.studyTypes != 2">
                                            <s:if test="#user.graduationTime != null && #user.completedTime != null">
                                                <a>您好，您的网络学时和现场学时已学满。</a>
                                            </s:if>
                                            <s:elseif test="#user.completedTime == null">
                                                <a>您好，您的网络学时未满。</a>
                                            </s:elseif>
                                            <s:elseif test="#user.graduationTime == null">
                                                <a>您好，您的现场学时未满。</a>
                                            </s:elseif>
                                        </s:if>
                                        <s:else>
                                            <s:if test="#user.completedTime != null">
                                                <a>您好，您的网络学时已学满。</a>
                                            </s:if>
                                            <s:else>
                                                <a>您好，您的网络学时未满。</a>

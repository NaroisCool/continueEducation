                            ...
                            <div class="box-content">                             
                                <div id="filter" class="row-fluid">
                                    <form id="export" action="action-admin-user-export">                           
                                        ...
                                        <div class="filter"><span title="培训完成时间(起始)">完成起始:</span><input time="time" type="text" class="input-medium" name="filter.graduationTimeBegin"></div>
                                        <div class="filter"><span title="培训完成时间(结束)">完成结束:</span><input time="time" type="text" class="input-medium" name="filter.graduationTimeEnd"></div>
                                        <div class="filter"><span>是否打印:</span><input type="text" class="input-medium" name="filter.status"></div>

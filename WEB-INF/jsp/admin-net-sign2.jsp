                    ...
                    <div class="row-fluid">
                        <div class="box span12">
                            ...
                            <div class="box-content">  
                                ...
                                <div class="row-fluid">
                                    <div class="filter"><span style="width: 85px;">培训时间:</span><input style="width: 125px;" time="datetime" type="text" class="input-medium" id="signBeginTime"></div>
                                    <div class="filter"><span style="width: 85px;">培训学时:</span><input style="width: 125px;" type="text" class="input-medium" id="studyTime" value="0"></div>
                                </div>  
                                <div id="result"></div>
                            </div>
                        </div>

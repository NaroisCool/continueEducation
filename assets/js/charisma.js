$(document).ready(function() {
    ...
    $('.main-menu .nav-header').click(function() {
        var val = $(this).attr('m');
        $('.main-menu li[c="' + val + '"]:not(.ctrlHide)').slideDown().removeClass('hidden');
        $('.main-menu li[c]:not([c="' + val + '"])').slideUp().addClass('hidden');
    });
    ...
    var c = $('.main-menu li.active').attr('c');
    $('.main-menu li[c="' + c + '"]:not(.ctrlHide)').slideDown().removeClass('hidden');
    $('.main-menu li[c]:not([c="' + c + '"])').slideUp().addClass('hidden');
